...
public class Getter {
    ...
    public static void loadMaps() throws IOException, ClassNotFoundException {
        ...
        file = new File("//DarkerList//moderators.yml");
        fis = new FileInputStream(file);
        try{
            ObjectInputStream ois = new ObjectInputStream(fis);
            Getter.mods = (List<String>) ois.readObject();
        } catch (EOFException e){
            Getter.mods = new ArrayList<String>();
            Getter.mods.add(Getter.AUTHOR.getId());
        }
    ...
    public static void checkFiles() throws IOException {
        ...
        File file6 = new File("//DarkerList//moderators.yml");
