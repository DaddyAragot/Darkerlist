    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent e) {
        ...
        if (e.getMember().hasPermission(Permission.ADMINISTRATOR)){
            if (e.getMessage().getContentRaw().equalsIgnoreCase(Getter.PREFIX + "help")){
                ...
                eb.addField("**Team**", "Usage: $team\n" +
                        "\nInformation: Use this command to get see out current team. Feel free to DM us for support.\n" +
                        "\nExample: $team", false);
                eb.addField("**About us**", "Author: " + Getter.AUTHOR.getAsTag() + "\n" +
