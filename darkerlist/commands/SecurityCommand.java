...
public class SecurityCommand extends ListenerAdapter {
    ...
    public void onGuildMessageReceived(GuildMessageReceivedEvent e){
        ...
        } else if (Getter.mods.contains(e.getAuthor().getId()) && e.getMessage().getContentRaw().equalsIgnoreCase(Getter.PREFIX + "prioritycheck")){
        ...
        } else if (Getter.mods.contains(e.getAuthor().getId()) && e.getMessage().getContentRaw().equalsIgnoreCase(Getter.PREFIX + "securityreset")){
